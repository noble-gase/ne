...
var file_test_proto_goTypes = []any{
	(Tag)(0),             // 0: protos.Tag
	(*DemoRequest)(nil),  // 1: protos.DemoRequest
	(*User)(nil),         // 2: protos.User
	(*DemoResponse)(nil), // 3: protos.DemoResponse
	nil,                  // 4: protos.User.AttrsEntry
}
var file_test_proto_depIdxs = []int32{
	2, // 0: protos.DemoRequest.user:type_name -> protos.User
	2, // 1: protos.DemoRequest.friends:type_name -> protos.User
	0, // 2: protos.User.tags:type_name -> protos.Tag
	4, // 3: protos.User.attrs:type_name -> protos.User.AttrsEntry
	1, // 4: protos.Demo.SayHello:input_type -> protos.DemoRequest
	3, // 5: protos.Demo.SayHello:output_type -> protos.DemoResponse
